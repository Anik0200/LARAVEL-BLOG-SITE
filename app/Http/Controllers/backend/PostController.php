...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($file) {
            ...
            $file->storeAs('public/storage/post/', $fileName);
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($file) {
            ...
            $upload = Image::make($file)->resize(540, 400)->save(public_path('storage/storage/post/' .

                $fileName));

            if ($upload) {
                unlink(public_path('storage/storage/post/') . $post->gallery->image);
            }
    ...
    public function permaDel($id)
    {
        ...
        $file =  public_path('storage/storage/post/') . $post->gallery->image;
